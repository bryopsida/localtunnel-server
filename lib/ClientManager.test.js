...
describe('ClientManager', () => {
  ...
  it('should remove client once it goes offline', {
    timeout: 5000
  }, async () => {
    const manager = new ClientManager()
  ...
  it('should remove correct client once it goes offline', {
    timeout: 5000
  }, async () => {
    const manager = new ClientManager()
  ...
  it('should remove clients if they do not connect within 5 seconds', {
    timeout: 5000
  }, async () => {
    const manager = new ClientManager()
